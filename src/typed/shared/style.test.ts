...
// style.ts is a deliberate one-line re-export (see its own top-of-file note); this test exists to prove the re-export actually resolves to document-schema.js's real schema/type, not to exercise any ODF-specific logic -- there is none in this file.
